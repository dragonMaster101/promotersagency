                    ...
                    <div class="brows-job-list">
                        ...
                        <div class="col-md-6 col-sm-5">
                            <div class="brows-job-position">
                                <a href="{{url('/jobdetails')}}"><h3>Digital Marketing Manager</h3></a>
                                <p>
                        ...
                        <div class="col-md-2 col-sm-2">
                            <div class="brows-job-link">
                                <a href="{{url('/jobdetails')}}" class="btn btn-default">Apply Now</a>
                            </div>
                        </div>
                    </div>
            ...
            <div class="item-click">
                <article>
                    <div class="brows-job-list">
                        ...
                        <div class="col-md-6 col-sm-5">
                            <div class="brows-job-position">
                                <a href="{{url('/jobdetails')}}"><h3>Compensation Analyst</h3></a>
                                <p>
            ...
            <div class="item-click">
                <article>
                    <div class="brows-job-list">
                        ...
                        <div class="col-md-6 col-sm-5">
                            <div class="brows-job-position">
                                <a href="{{url('/jobdetails')}}"><h3>Investment Banker</h3></a>
                                <p>
