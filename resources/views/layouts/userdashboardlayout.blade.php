...
<div id="wrapper" class="">
    ...
    <nav class="navbar navbar-default navbar-static-top"  style="margin-bottom: 0">
     ...
     {{--   <ul class="nav navbar-top-links navbar-right">
            ...
            <li class="dropdown">
                ...
                <div class="dropdown-menu dropdown-grid animated flipInX">
                    <a href="index.html" class="dropdown-item">
                        <img src="{{asset('userdashboard/assets/img/dashboard.png')}}" class="img-responsive" alt="" />
                        <span class="dropdown-title">Dashboard</span>
                    </a>
                    --}}{{--<a href="messages.html" class="dropdown-item">
                        <img src="{{asset('userdashboard/assets/img/chat.png')}}" class="img-responsive" alt="" />
                        <span class="dropdown-title">Chat</span>
                    </a>--}}{{--
                    --}}{{--<a href="settings.html" class="dropdown-item">
                        <img src="{{asset('userdashboard/assets/img/settings.png')}}" class="img-responsive" alt="" />
                        <span class="dropdown-title">Settings</span>
                    </a>--}}{{--
                    <a href="create-jobs.html" class="dropdown-item">
                        <img src="{{asset('userdashboard/assets/img/add-job.png')}}" class="img-responsive" alt="" />
                        <span class="dropdown-title">New CV</span>
                    </a>
                   --}}{{-- <a href="freelancers.html" class="dropdown-item">
                        <img src="{{asset('userdashboard/assets/img/freelancers.png')}}" class="img-responsive" alt="" />
                        <span class="dropdown-title">Freelancers</span>
                    </a>--}}{{--
                    <a href="my-profile.html" class="dropdown-item">
                        <img src="{{asset('userdashboard/assets/img/profile.png')}}" class="img-responsive" alt="" />
            ...
            <li class="dropdown">
                <a class="dropdown-toggle" data-toggle="dropdown" href="#">
                    <img src="{{asset('userdashboard/assets/img/user-1.jpg')}}" class="img-responsive img-circle" alt="user">
                </a>
